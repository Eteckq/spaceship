...
function initBackgroundShader() {
  ...
  backgroundShader.offsetUniform = gl.getUniformLocation(
    backgroundShader,
    "uOffset"
  );
  backgroundShader.amplitudeUniform = gl.getUniformLocation(
    backgroundShader,
    "uAmplitude"
  );
  backgroundShader.frequencyUniform = gl.getUniformLocation(
    backgroundShader,
    "uFrequency"
  );
  backgroundShader.persistenceUniform = gl.getUniformLocation(
    backgroundShader,
    "uPersistence"
  );
